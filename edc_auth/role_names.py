from .constants import (ACCOUNT_MANAGER_ROLE, AUDITOR_ROLE, CLINICIAN_ROLE, CUSTOM_ROLE,
                        DATA_EXPORTER_ROLE, DATA_MANAGER_ROLE, LAB_TECHNICIAN_ROLE, NURSE_ROLE,
                        PHARMACIST_ROLE, RANDO_VIEW_ROLE, SITE_COORDINATOR,
                        SITE_DATA_MANAGER_ROLE, SITE_PHARMACIST_ROLE, STAFF_ROLE, TMG_ROLE)
from .group_names import (ACCOUNT_MANAGER, ADMINISTRATION, AE, AE_REVIEW, AUDITOR,
                          ...
                          EVERYONE, EXPORT, LAB, LAB_VIEW, PHARMACY, PII, PII_VIEW, RANDO,
                          REVIEW, SCREENING, SITE_DATA_MANAGER, TMG, UNBLINDING_REQUESTORS,
